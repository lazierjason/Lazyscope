package com.swfjunkie.tweetr
{
	...
	public class Tweetr extends EventDispatcher
	{
		...
		public function Tweetr()
		{
			...
			urlRequest.idleTimeout = 10000;
			urlLoader = new URLLoader();
			
			urlLoader.addEventListener(Event.COMPLETE, handleTweetsLoaded);
			urlLoader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, handleSecurityError, true, 100);
		...
		private var _extend:Boolean = false;
		...
		public function getHomeTimeLine(since_id:String = null, since_date:String = null, max_id:String = null, count:Number = 0, page:Number = 0):void
		{
			...
			vars.include_rts = 't';
			vars.include_my_retweet = 't';
			vars.current_user_retweet = 't';
		 ...
		 * @param page            Optional. Provides paging. Ex. http://twitter.com/statuses/user_timeline.xml?page=3
		 */ 
		public function getUserTimeLine(id:String = null, since_id:String = null, since_date:String = null, max_id:String = null, page:Number = 0, count:Number = 0, extend:Boolean=false):void
		{
			var vars:URLVariables = new URLVariables();
		 ...
		 * @param page            Optional. Provides paging. Ex. http://twitter.com/statuses/user_timeline.xml?page=3
		 */ 
		public function getMentions(since_id:String = null, since_date:String = null, max_id:String = null, count:Number=0, page:Number = 0):void
		{
			var vars:URLVariables = new URLVariables();
			checkCredentials();
			_returnType = RETURN_TYPE_STATUS;
		 ...
		 * @param page            Optional. Provides paging. Ex. http://twitter.com/statuses/user_timeline.xml?page=3
		 */ 
		public function getRetweetsOfMe(since_id:String = null, max_id:String = null, count:Number = 0, page:Number = 0):void
		{
			var vars:URLVariables = new URLVariables();
			checkCredentials();
			_returnType = RETURN_TYPE_STATUS;
		 ...
		 */ 
		public function getFriends(id:String = null, cursor:String = '-1'):void
		{
			var vars:URLVariables = new URLVariables();
		 ...
		 * @param cursor    Optional. Breaks the results into pages. A single page contains 100 users. This is recommended for users who are following many users. Provide a value of  -1 to begin paging. Provide values as returned to in the response body's next_cursor and previous_cursor attributes to page back and forth in the list.
		 */ 
		public function getFollowers(id:String = null, cursor:String = '-1'):void
		{
			var vars:URLVariables = new URLVariables();            
			if (!id)
				checkCredentials();
		 ...
		 */ 
		public function getReceivedDirectMessages(since_id:String = null, since_date:String = null, max_id:String = null, page:Number = 0, count:Number = 100):void
		{
			var vars:URLVariables = new URLVariables();
			checkCredentials();
		 ...
		 * @param page          Optional. Retrieves the 20 next most recent direct messages.
		 */ 
		public function getSentDirectMessages(since_id:String = null, since_date:String = null, max_id:String = null, page:Number = 0, count:Number = 100):void
		{
			var vars:URLVariables = new URLVariables();
			checkCredentials();
			_returnType = RETURN_TYPE_DIRECT_MESSAGE;
		 ...
		 */ 
		public function getFriendIds(id:String = null, cursor:String = '-1'):void
		{
			var vars:URLVariables = new URLVariables();
		 ...
		 * @param cursor    Optional. Breaks the results into pages. A single page contains 5000 ids. This is recommended for users with large ID lists. Provide a value of -1 to begin paging. Provide values as returned to in the response body's next_cursor and previous_cursor attributes to page back and forth in the list.
		 */ 
		public function getFollowerIds(id:String = null, cursor:String = '-1'):void
		{
			var vars:URLVariables = new URLVariables();
		...
		public function updateProfileImage(fileReference:FileReference):void
		{
			checkCredentials();
			_returnType = RETURN_TYPE_USER_INFO;
			fileReference.addEventListener(DataEvent.UPLOAD_COMPLETE_DATA, handleFileReferenceUploadComplete, false, 0, true);
		...
		private function responseParser(data:Object):Array
		{
			...
			//if (_returnType == RETURN_TYPE_STATUS) {
			//trace('============================================================================================');
			//trace('* Request:', request);
			//trace('* Return Type:', _returnType);
			//trace(data);
			//trace('--------------------------------------------------------------------------------------------');
			//}
			setTimeout(System.disposeXML, 10, xml);
			switch (_returnType)
			{
				case RETURN_TYPE_STATUS:
					return DataParser.parseStatuses(xml, _extend);
		...
		{
			//			trace('handleTweetsLoaded', urlLoader.data);
		...
		{
			//			trace('handleTweetsLoadingFailed', event);
			//trace('========= IOErrorEvent !!! =================================================================');
			//trace('* Request:', request);
			//trace('* Return Type:', _returnType);
			//trace('--------------------------------------------------------------------------------------------');
